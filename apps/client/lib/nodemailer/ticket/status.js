...
export async function sendTicketStatus(ticket) {
  ...
  let info = await mail.sendMail({
    ...
    text: `Hello there, Ticket ${ticket.id}, now has a status of ${ticket.isComplete ? "COMPLETED" : "OUTSTANDING"}`, // plain text body
    html: `
    ...
    <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0" width="100%" style="max-width:600px;margin:0 auto">
      <tr style="width:100%">
        <td>
          ...
          <h1 style="color:#1d1c1d;font-size:16px;font-weight:700;margin:10px 0;padding:0;line-height:42px">Ticket Created: ${
            ticket.id
          }</h1>
